...
extern ErrorStatus RCC_EnableAHBPeripheral(u8 Copy_u8PeripheralName)
{
...
extern ErrorStatus RCC_DisableAHBPeripheral(u8 Copy_u8PeripheralName)
{
	u32 Local_u32RCC_AHBENR = RCC->AHBENR;
	Local_u32RCC_AHBENR &= (Copy_u8PeripheralName);
	RCC->AHBENR = Local_u32RCC_AHBENR;
...
extern ErrorStatus RCC_EnableAPB2Peripheral(u8 Copy_u8PeripheralName)
{
...
extern ErrorStatus RCC_DisableAPB2Peripheral(u8 Copy_u8PeripheralName)
{
...
extern ErrorStatus RCC_EnableAPB1Peripheral(u8 Copy_u8PeripheralName)
{
...
extern ErrorStatus RCC_DisableAPB1Peripheral(u8 Copy_u8PeripheralName)
{
